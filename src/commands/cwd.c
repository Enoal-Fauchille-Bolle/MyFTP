 ...
 *
 * Checks if the working directory is within the server's root path.
 * If not, resets it to the current directory.
 *
 * @param connection The client connection structure
 */
 ...
 *
 * Performs directory change operation with proper validation and path updates.
...
/**
 * @brief Handles the CWD (Change Working Directory) FTP command
 *
